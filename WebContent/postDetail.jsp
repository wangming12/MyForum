...
<script type="text/javascript">
	...
	function getData(value) {
		...
		var html = "<div><font size='3px' color='#0088D8'><b>当前位置 &nbsp;&nbsp;》》》&nbsp;&nbsp;</b></font>帖子详情<br/><br/></div>"
				...
				+ "<img class='img-circle' style='width:30px; height:30px; float:left; margin-right:10px;' src='" + post[0].userPhoto +"'/>" 
				+ "<div id='title'>"
				+ post[0].title
				+ "</div>"
				+ "<div id='addPostBtn'>"
		...
		$("#head").html($(html));
		console.log(post[0].publishTime);
		setComments(value);
	};
		...
		if (state == "success") {
			...
			for ( var i = 0; i < obj.length; i++) {
				str += "<div class='panel panel-info'>"
						+ "<div class='panel-heading'>"
						+ "<img class='img-circle' style='width:30px; height:30px; float:left; margin-right:50px' src='" + obj[i].userPhoto +"'/>" 
